...
const CustomerServiceChatUser: React.FC = () => {
        ...
        <Theme>
            ...
            {messages.map((message, index) => (
                <div style={{
                    ...
                    <p key={index}>
                    {message.SenderID == "1" ? "User": "Customer Service"}: {message.Message}
                    </p>
                </div>
            ))}
            <input
...
export default CustomerServiceChatUser;